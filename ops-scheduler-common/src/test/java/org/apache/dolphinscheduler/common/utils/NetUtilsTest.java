...
public class NetUtilsTest {
    ...
    public void testGetHost() {
        ...
        when(address.getCanonicalHostName()).thenReturn("ops-scheduler-worker-0.ops-scheduler-worker-headless.default.svc.cluster.local");
        when(address.getHostName()).thenReturn("ops-scheduler-worker-0");
        ...
        assertEquals("ops-scheduler-worker-0.ops-scheduler-worker-headless", NetUtils.getHost(address));
        ...
        address = mock(InetAddress.class);
        when(address.getCanonicalHostName()).thenReturn("ops-scheduler-worker-0");
        when(address.getHostName()).thenReturn("ops-scheduler-worker-0");
        Whitebox.setInternalState(Constants.class, "KUBERNETES_MODE", true);
        assertEquals("ops-scheduler-worker-0", NetUtils.getHost(address));
    }
