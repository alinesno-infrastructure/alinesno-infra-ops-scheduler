...
//    private static final String REGISTRY_CONFIG_FILE_PATH = "/registry.properties";
    ...
    private void start() {
        if (isStarted.compareAndSet(false, true)) {
            ...
            Map<String, String> registryConfig = new HashMap<>() ; //  PropertyUtils.getPropertiesByPrefix(REGISTRY_PREFIX);
            
            registryConfig.put("plugin.name" , registryClientProperties.getPluginName()) ;
            registryConfig.put("servers" , registryClientProperties.getServers()) ;
            registryConfig.put("namespace" , registryClientProperties.getNamespace() ) ;
            registryConfig.put("base.sleep.time.ms" , registryClientProperties.getBaseSleepTimeMs() + "" ) ;
            registryConfig.put("max.sleep.ms" , registryClientProperties.getMaxSleepMs() + "" ) ;
            registryConfig.put("max.retries" , registryClientProperties.getMaxRetries() + "" ) ;
            registryConfig.put("session.timeout.ms" , registryClientProperties.getSessionTimeoutMs() + "" ) ;
            registryConfig.put("connection.timeout.ms" , registryClientProperties.getConnectionTimeoutMs() + "" ) ;
            registryConfig.put("block.until.connected.wait" , registryClientProperties.getBlockUntilCconnectedWwait() +"" ) ;
            registryConfig.put("digest",registryClientProperties.getDigest() );
