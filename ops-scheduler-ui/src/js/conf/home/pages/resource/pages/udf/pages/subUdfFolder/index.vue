    ...
    <template slot="content">
      <div class="resource-create-model">
        ...
        <m-list-box-f>
          ...
          <template slot="content">
            <div class="submit">
              <el-button type="primary" size="small" :loading="spinnerLoading" @click="ok()">{{spinnerLoading ? $t('Loading...') : $t('Create')}} </el-button>
              <el-button type="text" size="small" @click="() => $router.push({name: 'resource-udf-subUdfDirectory'})"> {{$t('Cancel')}} </el-button>
            </div>
          </template>
        </m-list-box-f>
      </div>
