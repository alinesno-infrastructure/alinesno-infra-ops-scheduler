    ...
    <div class="conditions-box">
      <m-conditions @on-conditions="_onConditions">
        <template slot="button-group">
          <el-button-group>
            <el-button  size="small" @click="() => $router.push({path: `/resource/file/subFileFolder/${searchParams.id}`})">{{$t('Create folder')}}</el-button>
            <el-button size="small" @click="() => $router.push({path: `/resource/file/subFile/${searchParams.id}`})">{{$t('Create File')}}</el-button>
            <el-button size="small" @click="_uploading">{{$t('Upload Files')}}</el-button>
          </el-button-group>
        </template>
      </m-conditions>
    </div>
