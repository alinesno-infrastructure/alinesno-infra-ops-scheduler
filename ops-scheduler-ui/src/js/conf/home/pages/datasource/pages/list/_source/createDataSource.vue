...
<template>
  <div class="datasource-popup-model">
    ...
    <div class="bottom-p">
      ...
      <el-button type="success" size="small" @click="_testConnect()" :loading="testLoading">{{testLoading ? $t('Loading...') : $t('Test Connect')}}</el-button>
      <el-button type="primary" size="small" :loading="spinnerLoading" @click="_ok()">{{spinnerLoading ? $t('Loading...') :item ? `${$t('Edit')}` : `${$t('Submit')}`}} </el-button>
    </div>
  </div>
</template>
<script>
