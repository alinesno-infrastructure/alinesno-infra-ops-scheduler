          ...
          <template slot-scope="scope">
            <el-tooltip :content="$t('Authorize')" placement="top">
              <el-dropdown trigger="click">
                <el-button type="warning" size="small" icon="el-icon-user"  ></el-button>
            ...
            <el-tooltip :content="$t('Edit')" placement="top">
              <el-button type="primary" size="small" icon="el-icon-edit-outline" @click="_edit(scope.row)"  ></el-button>
            </el-tooltip>
