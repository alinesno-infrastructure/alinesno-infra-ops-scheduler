  ...
  <m-popover
    ...
    <template slot="content">
      <div class="create-user-model">
        ...
        <!--
        <m-list-box-f>
          <template slot="name"><strong>*</strong>{{$t('Nick Name')}}</template>
          <template slot="nickName">
            <el-input
                    ...
                    maxlength="60"
                    size="small"
                    :placeholder="$t('Please enter nick name')">
            </el-input>
          </template>
        </m-list-box-f>
        -->
          ...
          <template slot="content">
            <el-select v-model="queueName" style="width: 100%;" size="small">
              <el-input slot="trigger" slot-scope="{ selectedModel }" readonly :placeholder="$t('Please select a queue')" :value="selectedModel ? selectedModel.label : ''" @on-click-icon.stop="queueName = ''">
                ...
                <em slot="suffix" class="el-icon-bottom" style="font-size: 13px;" v-show="queueName!=''"></em>
              </el-input>
              <el-option
