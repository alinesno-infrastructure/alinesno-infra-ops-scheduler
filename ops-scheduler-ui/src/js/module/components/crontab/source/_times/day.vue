...
<template>
  <div class="day-model">
    <div class="v-crontab-form-model">
      <el-radio-group v-model="radioDay" vertical size="small">
        <div class="list-box">
        ...
        <div class="list-box">
          <el-radio label="WkintervalWeek">
            ...
            <el-select :placeholder="$t('请选择具体小时数')" style="width: 200px" size="small" v-model="WkintervalWeekStartVal">
              <el-option
        ...
        <div class="list-box">
          <el-radio label="intervalDay" size="small">
            <span class="text">{{$t('每隔')}}</span>
        ...
        <div class="list-box">
          <el-radio label="WkspecificWeek" size="small">
            <!--<span class="text">（周）</span>-->
            <span class="text">{{$t('具体星期几(可多选)')}}</span>
            <el-select multiple size="small" :placeholder="$t('请选择具体周几')" v-model="WkspecificWeekVal">
              <el-option
        ...
        <div class="list-box">
          <el-radio label="specificDay" size="small">
            <span class="text">{{$t('具体天数(可多选)')}}</span>
            <el-select multiple size="small" :placeholder="$t('请选择具体天数')" v-model="WkspecificDayVal">
              <el-option
        ...
        <div class="list-box">
          <el-radio label="monthLastDays" size="small">
            <span class="text">{{$t('在这个月的最后一天')}}</span>
          </el-radio>
        </div>
        <div class="list-box">
          <el-radio label="monthLastWorkingDays" size="small">
            <span class="text">{{$t('在这个月的最后一个工作日')}}</span>
          </el-radio>
        </div>
        <div class="list-box">
          <el-radio label="monthLastWeeks" size="small">
            <span class="text">{{$t('在这个月的最后一个')}}</span>
            <el-select size="small" :placeholder="$t('请选择具体周几')" v-model="monthLastWeeksVal">
              <el-option
        ...
        <div class="list-box">
          <el-radio label="monthTailBefore" size="small">
        ...
        <div class="list-box">
          <el-radio label="recentlyWorkingDaysMonth" size="small">
        ...
        <div class="list-box">
          <el-radio label="WkmonthNumWeeks" size="small">
            <!--<span class="text">（周）</span>-->
            ...
            <el-select :placeholder="$t('请选择具体周几')" size="small" style="width: 200px; margin-left: 65px;"  v-model="WkmonthNumWeeksWeekVal">
              <el-option
