...
<template>
  <div class="year-model">
    <div class="v-crontab-form-model">
      <el-radio-group v-model="radioYear" vertical size="small">
        <div class="list-box">
        ...
        <div class="list-box">
          <el-radio label="specificYear">
            ...
            <el-select multiple :placeholder="$t('请选择具体年数')" size="small" v-model="specificYearVal" @change="onspecificYears">
              <el-option
