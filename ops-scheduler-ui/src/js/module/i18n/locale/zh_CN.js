...
export default {
  ...
  Datasource: '数据源',
  methods: '方法',
  'Please enter the procedure method':
    '请输入存储脚本 \n\n调用存储过程：{call <procedure-name>[(<arg1>,<arg2>, ...)]}\n\n调用存储函数：{?= call <procedure-name>[(<arg1>,<arg2>, ...)]} ',
  'The procedure method script example':
    '示例：{call <procedure-name>[(?,?, ...)]} 或 {?= call <procedure-name>[(?,?, ...)]}',
  Script: '脚本',
  ...
  'Please enter a password (6-22) character password':
    '请输入密码(6-22)字符密码',
  ...
  'File Upload': '文件上传',
  'Drag the file into the current upload window':
    '请将文件拖拽到当前上传窗口内！',
