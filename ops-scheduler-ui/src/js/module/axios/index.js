...
class InnerCtor {
    ...
    this.config = Object.assign(
      {
        // TODO 待配置成env变量
        baseURL: `${BASE_URL}`,
        // ? 'http://127.0.0.1:12345' : `${BASE_URL}`,
        // baseURL: 'http://dolphinscheduler.admin.beta.linesno.com',
        timeout: 0,
        resolveURL: (u) => u
      },
      defaults
  ...
  jsonp (url, data, success, fail, config) {
    ...
    configs.config = _.merge({}, this.config, configs.config)
    configs.url = buildURL(
      resolveURL(configs.config.baseURL, configs.config.url),
