  ...
  <m-popup :ok-text="$t('Submit')" :nameText="resourceData.type.name + $t('Authorize')" @ok="_ok" @close="close" ref="popup">
    <template slot="content">
      <div class="clearfix transfer-model" style="width: 660px">
        <div>
            <el-button-group>
                <el-button size="small" value="fileResource" @click="_ckFile">{{$t('File resources')}}</el-button>
                <el-button size="small" value="udfResource" @click="_ckUDf">{{$t('UDF resources')}}</el-button>
            </el-button-group>
        </div>
