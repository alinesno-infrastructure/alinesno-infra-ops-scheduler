...
<template>
  <div class="hour-model">
    <div class="v-crontab-form-model">
      <el-radio-group v-model="radioHour" vertical size="small">
        <div class="list-box">
        ...
        <div class="list-box">
          <el-radio label="intervalHour" size="small">
        ...
        <div class="list-box">
          <el-radio label="specificHour" size="small">
        ...
        <div class="list-box">
          <el-radio label="cycleHour" size="small">
