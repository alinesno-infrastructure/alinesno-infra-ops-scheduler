...
<template>
  <div class="month-model">
    <div class="v-crontab-form-model">
      <el-radio-group v-model="radioMonth" vertical size="small">
        <div class="list-box">
          <el-radio label="everyMonth" size="small">
            <span class="text">{{$t('每一月')}}</span>
          </el-radio>
        </div>
        <div class="list-box">
          <el-radio label="intervalMonth" size="small">
        ...
        <div class="list-box">
          <el-radio label="specificlMonth">
            ...
            <el-select multiple :placeholder="$t('请选择具体月数')" size="small" v-model="specificMonthVal" @change="onspecificlMonths">
              <el-option
        ...
        <div class="list-box">
          <el-radio label="cycleMonth" size="small">
