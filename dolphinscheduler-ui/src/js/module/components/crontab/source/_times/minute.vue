...
<template>
  <div class="minute-model">
    <div class="v-crontab-form-model">
      <el-radio-group v-model="radioMinute" vertical size="small">
        <div class="list-box">
        ...
        <div class="list-box">
          <el-radio label="intervalMinute" size="small">
        ...
        <div class="list-box">
          <el-radio label="specificMinute" size="small">
            <span class="text">{{$t('具体分钟数(可多选)')}}</span>
            <el-select multiple :placeholder="$t('请选择具体分钟数')" size="small" v-model="specificMinutesVal" @change="onspecificMinutes">
              <el-option
        ...
        <div class="list-box">
          <el-radio label="cycleMinute" size="small">
