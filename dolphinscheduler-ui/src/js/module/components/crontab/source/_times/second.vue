...
<template>
  <div class="second-model">
    <div class="v-crontab-form-model">
      <el-radio-group v-model="radioSecond" vertical size="small">
        <div class="list-box">
        ...
        <div class="list-box">
          <el-radio label="specificSecond">
            ...
            <el-select multiple size="small" :placeholder="$t('请选择具体秒数')" v-model="specificSecondsVal" @change="onSpecificSeconds">
              <el-option
