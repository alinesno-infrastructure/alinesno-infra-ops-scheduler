  ...
  <div class="list-model">
    <div class="table-box">
      <el-table :data="list" size="small" style="width: 100%">
        ...
        <el-table-column prop="taskType" :label="$t('Node Type')" align="center"></el-table-column>
        <el-table-column :label="$t('State')" width="50" align="center">
          <template slot-scope="scope">
            <span v-html="_rtState(scope.row.state)" style="cursor: pointer;"></span>
          </template>
        </el-table-column>
        <el-table-column :label="$t('Submit Time')" width="145" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column :label="$t('host')" min-width="210" :show-overflow-tooltip="true">
          <template slot-scope="scope">
          ...
          <template slot-scope="scope">
            <div>
              <el-tooltip :content="$t('Force success')" placement="top" :enterable="false">
                <span>
                  <el-button type="primary" size="small" circle icon="el-icon-success" :disabled="!(scope.row.state === 'FAILURE' || scope.row.state === 'NEED_FAULT_TOLERANCE' || scope.row.state === 'KILL')" @click="_forceSuccess(scope.row)"  ></el-button>
                </span>
              </el-tooltip>
              <el-tooltip :content="$t('View log')" placement="top" :enterable="false">
                <span><el-button type="primary" size="small" circle :disabled="scope.row.taskType==='SUB_PROCESS'? true: false"  icon="el-icon-tickets" @click="_refreshLog(scope.row)"  ></el-button></span>
              </el-tooltip>
            </div>
          </template>
        </el-table-column>
