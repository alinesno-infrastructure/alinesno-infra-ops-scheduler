            ...
            <el-table-column :label="$t('Operation')" width="220">
              <template slot-scope="scope">
                <el-tooltip :content="$t('Edit')" placement="top">
                  <span><el-button type="primary" size="small" icon="el-icon-edit-outline" :disabled="scope.row.releaseState === 'ONLINE'" @click="_editTiming(scope.row)"  ></el-button></span>
                </el-tooltip>
                <el-tooltip :content="$t('online')" placement="top" v-if="scope.row.releaseState === 'OFFLINE'">
                  <span><el-button type="warning" size="small" icon="el-icon-upload2" @click="_online(scope.row)"  ></el-button></span>
                </el-tooltip>
                <el-tooltip :content="$t('offline')" placement="top" v-if="scope.row.releaseState === 'ONLINE'">
                  <span><el-button type="danger" size="small" icon="el-icon-download" @click="_offline(scope.row)"  ></el-button></span>
                </el-tooltip>
