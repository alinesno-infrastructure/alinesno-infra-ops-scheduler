        ...
        <el-table-column :label="$t('Operation')" width="250">
          <template slot-scope="scope">
            <el-tooltip :content="$t('Edit')" placement="top" :enterable="false">
              <span><el-button type="primary" size="small" icon="el-icon-edit-outline" @click="_edit(scope.row)" :disabled="_rtDisb(scope.row)"  ></el-button></span>
            </el-tooltip>
            <el-tooltip :content="$t('Rename')" placement="top" :enterable="false">
              <span><el-button type="primary" size="small" icon="el-icon-edit" @click="_rename(scope.row,scope.$index)"  ></el-button></span>
            </el-tooltip>
<!--            <el-tooltip :content="$t('Download')" placement="top" :enterable="false">-->
<!--              <span><el-button type="primary" size="small" icon="el-icon-download" @click="_downloadFile(scope.row)" :disabled="scope.row.directory? true: false"  ></el-button></span>-->
<!--            </el-tooltip>-->
